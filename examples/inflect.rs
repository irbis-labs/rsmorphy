...
fn main() {
    ...
    println!(
        " ::: {} {} + {} {} = {} {}",
        1, apple.get_plural(&morph_ru, 1).unwrap(),
        4, apple.get_plural(&morph_ru, 4).unwrap(),
        5, apple.get_plural(&morph_ru, 5).unwrap(),
    );
    println!(
        " ::: {} {} - {} {} = {} {}",
        102, apple.get_plural(&morph_ru, 102).unwrap(),
        11,  apple.get_plural(&morph_ru, 11).unwrap(),
        91,  apple.get_plural(&morph_ru, 91).unwrap(),
    );
    println!(
        " ::: {} {} сыт не будешь",
        1, apple.inflect(&morph_ru, &ablt_set).unwrap().get_plural(&morph_ru, 1).unwrap(),
    );
    println!(
        " ::: накормил {} {}",
